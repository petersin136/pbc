...
export const SECTION_KINDS = [
  ...
  { value: "quick-links", label: "⚡ 바로가기 링크" },
  { value: "five-k-movement", label: "✝️ Five K Movement" },
...
export const PAGES = [
  ...
  { value: "education-youth", label: "🎓 교육부서 > 청년부" },
  { value: "education-highschool", label: "🎓 교육부서 > 중고등부" },
  { value: "education-sunday-school", label: "🎓 교육부서 > 주일학교" },
  { value: "education-kindergarten", label: "🎓 교육부서 > 유치부" },
  { value: "education-bible-study", label: "🎓 교육부서 > 성경공부" },
  { value: "choir-yada", label: "🎵 찬양 > 야다 성가대" },
  { value: "choir-joyful", label: "🎵 찬양 > 기쁜소리 찬양단" },
  { value: "choir-terua", label: "🎵 찬양 > 테루아 찬양단" },
  { value: "nurture-newcomer", label: "🌱 양육 > 새신자 양육" },
  { value: "nurture-leader", label: "🌱 양육 > 목장(리더) 양육" },
  ...
  { value: "news-bulletin", label: "📰 교회소식 > 주보" },
  { value: "news-notices", label: "📰 교회소식 > 공지사항" },
  { value: "news-prayer", label: "📰 교회소식 > 기도제목" },
  { value: "news-testimony", label: "📰 교회소식 > 간증" },
