...
import type { NoticesContent, NoticeItem } from "@/lib/blocks";
import Image from "next/image";

export type NoticesSectionMeta = Pick<Section, "id" | "page" | "kind" | "title">;
          ...
          {notices.length > 0 ? (
            <div className="space-y-6 animate-fade-in-up animation-delay-200">
              {[...notices]
                ...
                .map((notice: NoticeItem, index: number) => (
                <div
                  key={index}
