...
export default function HighschoolAdminPage() {
  ...
  const PAGE_ID = "education-highschool";
  ...
  return (
    <div className="max-w-5xl mx-auto">
      <div className="mb-6">
        <h1 className="text-2xl font-bold text-gray-900 mb-4">📚 중고등부 관리</h1>
        <p className="text-gray-600 mb-4">
          중고등부 페이지의 콘텐츠를 관리합니다.
        </p>
      ...
      {sections.length === 0 ? (
        <EmptyState
          icon="📚"
          title="섹션이 없습니다"
          description="중고등부 페이지에 아직 섹션이 없습니다."
          actionLabel="섹션 추가"
          onAction={handleAdd}
        />
      ) : (
